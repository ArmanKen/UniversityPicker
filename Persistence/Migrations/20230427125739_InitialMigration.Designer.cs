...
namespace Persistence.Migrations
{
	...
	[Migration("20230427125739_InitialMigration")]
...
#pragma warning disable 612, 618
			...
			modelBuilder.Entity("PhotoHigherEducationFacility", b =>
				{
					b.Property<string>("PhotosId")
						.HasColumnType("text");

					b.Property<Guid>("HigherEducationFacilitesId")
						.HasColumnType("uuid");

					b.HasKey("PhotosId", "HigherEducationFacilitesId");

					b.HasIndex("HigherEducationFacilitesId");

					b.ToTable("PhotoHigherEducationFacility");
				});
			...
			modelBuilder.Entity("PhotoHigherEducationFacility", b =>
				{
					...
					b.HasOne("Domain.HigherEducationFacility", null)
						.WithMany()
						.HasForeignKey("HigherEducationFacilitesId")
						.OnDelete(DeleteBehavior.Cascade)
						.IsRequired();
				});
