	...
	public partial class InitialMigration : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_HigherEducationFacilites", x => x.Id);
					table.ForeignKey(
						name: "FK_HigherEducationFacilites_Accreditations_AccreditationId",
						column: x => x.AccreditationId,
						principalTable: "Accreditations",
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_HigherEducationFacilites_Cities_CityId",
						column: x => x.CityId,
						principalTable: "Cities",
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_HigherEducationFacilites_Locations_LocationId",
						column: x => x.LocationId,
						principalTable: "Locations",
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_HigherEducationFacilites_Regions_RegionId",
						column: x => x.RegionId,
						principalTable: "Regions",
						principalColumn: "Id");
				});
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						...
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_Faculties_HigherEducationFacilites_HigherEducationFacilityId",
			...
			migrationBuilder.CreateTable(
				name: "PhotoHigherEducationFacility",
				columns: table => new
				{
					PhotosId = table.Column<string>(type: "text", nullable: false),
					HigherEducationFacilitesId = table.Column<Guid>(type: "uuid", nullable: false)
				},
				constraints: table =>
				{
					table.PrimaryKey("PK_PhotoHigherEducationFacility", x => new { x.PhotosId, x.HigherEducationFacilitesId });
					table.ForeignKey(
						name: "FK_PhotoHigherEducationFacility_Photos_PhotosId",
						column: x => x.PhotosId,
						principalTable: "Photos",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_PhotoHigherEducationFacility_HigherEducationFacilites_HigherEducationFacilitesId",
						column: x => x.HigherEducationFacilitesId,
						principalTable: "HigherEducationFacilities",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
				});
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						...
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_AspNetUsers_HigherEducationFacilites_HigherEducationFacilityId",
						column: x => x.HigherEducationFacilityId,
						principalTable: "HigherEducationFacilities",
						principalColumn: "Id");
				});
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					HigherEducationFacilityId = table.Column<Guid>(type: "uuid", nullable: false)
				},
				constraints: table =>
				{
					table.PrimaryKey("PK_FavoriteLists", x => new { x.AppUserId, x.HigherEducationFacilityId });
					table.ForeignKey(
						...
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_FavoriteLists_HigherEducationFacilites_HigherEducationFacilityId",
						column: x => x.HigherEducationFacilityId,
						principalTable: "HigherEducationFacilities",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						...
						principalColumn: "Id");
					table.ForeignKey(
						name: "FK_Reviews_HigherEducationFacilites_HigherEducationFacilityId",
						column: x => x.HigherEducationFacilityId,
						principalTable: "HigherEducationFacilities",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						...
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_HigherEducationFacilitesAdmins_HigherEducationFacilites_HigherEducationFacilityId",
						column: x => x.HigherEducationFacilityId,
						principalTable: "HigherEducationFacilities",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateIndex(
				name: "IX_AspNetUsers_HigherEducationFacilityId",
				table: "AspNetUsers",
			...
			migrationBuilder.CreateIndex(
				name: "IX_Faculties_HigherEducationFacilityId",
				table: "Faculties",
				column: "HigherEducationFacilityId");
			...
			migrationBuilder.CreateIndex(
				name: "IX_FavoriteLists_HigherEducationFacilityId",
				table: "FavoriteLists",
				column: "HigherEducationFacilityId");
			...
			migrationBuilder.CreateIndex(
				name: "IX_PhotoHigherEducationFacility_HigherEducationFacilitesId",
				table: "PhotoHigherEducationFacility",
				column: "HigherEducationFacilitesId");
			...
			migrationBuilder.CreateIndex(
				name: "IX_Reviews_HigherEducationFacilityId",
				table: "Reviews",
				column: "HigherEducationFacilityId");
			...
			migrationBuilder.CreateIndex(
				name: "IX_HigherEducationFacilites_AccreditationId",
				table: "HigherEducationFacilities",
				column: "AccreditationId");

			migrationBuilder.CreateIndex(
				name: "IX_HigherEducationFacilites_CityId",
				table: "HigherEducationFacilities",
				column: "CityId");

			migrationBuilder.CreateIndex(
				name: "IX_HigherEducationFacilites_LocationId",
				table: "HigherEducationFacilities",
				column: "LocationId");

			migrationBuilder.CreateIndex(
				name: "IX_HigherEducationFacilites_RegionId",
				table: "HigherEducationFacilities",
				column: "RegionId");
